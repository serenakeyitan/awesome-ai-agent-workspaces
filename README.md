...
Tracking AI coworking / workspace products and frameworks for **one-person companies** and **teams** — where AI agents are persistent teammates in a shared workspace, not one-off tools.

**Legend** — **For:** Solo / Team · **Use:** General (any role) / Eng (coding work) · **Run:** Cloud / Local / Both · **Price:** Free (OSS) / Freemium / Paid

| Product | For | Use | Run | Price | Runtimes | What makes it different |
|---|---|---|---|---|---|---|
...
2. A hosted "Multica Cloud" tier exists but its price is not published.
3. Slock's Team / Business tiers are "coming soon" — no price yet; Hobby is $0.
4. Hivespace is login-gated; cloud deployment is inferred, not officially stated.
5. Vibe Kanban is sunsetting (Apr 2026) → community-maintained. A $30/user/mo "Pro" cloud tier existed but is no longer a live offering.

*All facts verified against primary sources (live sites, GitHub, npm), June 2026. This space moves fast — verify before relying on pricing.*
